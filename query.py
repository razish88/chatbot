...
# add api_key=st.secrets["openai_api_key"] to ChatOpenAI&OpenAIEmbeddings to run from github after deploying to streamlit
...
documents = TextLoader(r"03\1\docs\faq.txt").load()
